...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.47\textwidth]{results/plots/metrics_bar_auroc_test.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.47\textwidth]{results/plots/vep_heatmap_test.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.47\textwidth]{results/plots/topk_bar_test.png}
