...
\begin{figure*}[!t]
    ...
    {../notebooks/results/plots/metrics_bar_auroc_test.png}
...
\begin{figure*}[!t]
    ...
    {../notebooks/results/plots/metrics_bar_prauc_all.png}
...
The following contributions summarize my work on this project and may be used for attribution or grading:
\begin{itemize}
